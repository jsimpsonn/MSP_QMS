...
import SendEmailButton from '@/components/email-template';
              ...
              <div className="mt-4">
                <Accordion type="single" collapsible>
                  ...
                  <AccordionItem value="item-2">
                    <AccordionTrigger className="accordion-trigger">I dont like a form I use. Can I make changes to it?</AccordionTrigger>
                    <AccordionContent>

    ...
    <div>
      ...
      <section className="py-10">
        <div className="flex flex-wrap justify-around mt-8">
          {/* Card 1 */}
          <div 
            className="flex flex-col space-y-2 flex-1 min-w-0 border rounded-lg p-4 shadow-md m-2 text-center items-center justify-center transition-all duration-200 ease-in-out transform hover:scale-85 hover:shadow-lg cursor-pointer" 
